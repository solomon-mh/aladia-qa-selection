describe('template spec', () => {
  ...
  it('login-page-test', function() {
    ...
    cy.get(':nth-child(2) > .group > .flex-1').should('have.attr', 'placeholder', 'Surname');
    cy.get('[value="solomo@gmail.com"] > .group > .flex-1').click();
    cy.get('[value="solomo@gmail.com"] > .group > .flex-1').should('be.visible');
    ...
    cy.get(':nth-child(4) > .group > .flex-1').click();
    cy.get(':nth-child(4) > .group > .flex-1').should('have.attr', 'placeholder', 'Password');
    cy.get(':nth-child(5) > .group > .flex-1').click();
    cy.get(':nth-child(5) > .group > .flex-1').should('have.attr', 'placeholder', 'Confirm Password');
    cy.get('[value="solomo@gmail.com"] > .group > .flex-1').click();
    cy.get('[value="solomo@gmail.com"] > .group > .flex-1').should('have.attr', 'type', 'text');
